...
//Name: Maya Lamp.ma
//Last modified: Fri, Jan 26, 2024 09:53:49 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "8A11A1B5-44E3-40BD-7ACC-80BE76599592";
createNode transform -s -n "persp";
	rename -uid "82448FE4-48FE-C6BB-086C-B5B96230D08C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -22.322362093368763 7.1649901537284739 -8.7534036901415888 ;
	setAttr ".r" -type "double3" -2.3999999999980188 -1901.5999999997628 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 24.058141181499568;
...
createNode transform -s -n "top";
	...
	setAttr ".rpt" -type "double3" -2.109782377274627e-14 -6.94091583595506e-14 -3.7200737799055205e-14 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BA3A7FE5-4B31-12DF-C677-B598287ED23B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BA8D7344-4A4E-6B4A-E97B-EF8682D5F313";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E3A7FC31-481F-3059-7120-7B9E9DBAF885";
createNode displayLayerManager -n "layerManager";
	rename -uid "85A1F1B5-4ECB-DBC5-84AD-8FB912C26D1C";
createNode displayLayer -n "defaultLayer";
	rename -uid "C9D74D2D-4517-2FF1-7CA2-D6B0F7AE7F0B";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "ADE5E435-4F8F-9059-C488-02B33C5AF050";
...
createNode animCurveTA -n "pCube9_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1.6128516200618443;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "766E8E11-4592-53E1-04DF-DBBD3454D943";
